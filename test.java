...
import com._1forge.java.Symbol;
import com._1forge.java.Quote;
...
public class test {
    public static void main(String args[]) {
        ...
        // }
        try {
            // 955 pairs 7648 character
            String[] tickers = { "EUR/USD", "HUF/CHF", "TWD/SEK", "GNF/USD", "DKK/EUR", "GBP/SGD", "NPR/USD", "USD/CLY",
                    ...
                    "CAD/JPY", "OMR/USD", "PLN/HKD", "MXN/SGD", "XPTK/CHF", "USD/AMD", "USD/SBD", "M5P/CHF", "CZK/PLN",
                    // "CNY/GBP",
                    "MYR/PKR", "INR/KRW" };
